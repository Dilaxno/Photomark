...
# ---- CORS setup ----
origins = [o.strip() for o in os.getenv("ALLOWED_ORIGINS", "https://photomark.cloud,https://www.photomark.cloud,http://localhost:5173,http://127.0.0.1:5173").split(",") if o.strip()]
app.add_middleware(
    CORSMiddleware,
