...
async def affiliates_invite(request: Request, email: str = Body(..., embed=True), channel: str = Body("", embed=True)):
    ...
    try:
        ...
        btn_color = os.getenv("EMAIL_BRAND_BUTTON_BG", "#7AA2F7")
        ...
        intro_html = (
            ...
            f"<a href=\"https://photomark.cloud\" style=\"color:{btn_color}; text-decoration:underline;\">Explore Photomark</a><br><br>"
