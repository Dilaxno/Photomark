...
<style>
    ...
    .card {{ display:inline-block; width:100%; margin:0 0 16px; border:1px solid {border}; border-radius:10px; overflow:hidden; background:{card_bg}; box-shadow: 0 4px 12px {shadow}; break-inside: avoid; }}
    /* Frame enforces target aspect ratios: 1:1 (600x600) or 2:3 (600x900 portrait) */
    .frame {{ position: relative; width: 100%; background:#111; }}
