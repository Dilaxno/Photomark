...
async def ai_retouch_instruct_pix2pix(
    ...
    """
    Calls Hugging Face to apply text-guided edits (timbrooks/instruct-pix2pix).
    Uses huggingface_hub InferenceClient image_to_image to avoid API shape issues.
    """
    ...
    try:
        ...
        client = InferenceClient(model="timbrooks/instruct-pix2pix", token=token)
        ...
        # Call image_to_image; returns a PIL Image
