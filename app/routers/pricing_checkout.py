...
async def create_pricing_link(request: Request):
    ...
    # Prepare alternate payload shapes (field casing and structures vary)
    alt_payloads = [
        base_payload,
        {
            **common_top,
        ...
        },
        {
            **common_top,
            "metadata": base_payload["metadata"],
            "products": [{"productId": product_id, "quantity": qty}],
        ...
        {
            # camelCase variant for business/brand
            "businessId": business_id,
            **({"brandId": brand_id} if brand_id else {}),
            "metadata": base_payload["metadata"],
            "products": [{"productId": product_id, "quantity": qty}],
            "redirectUrl": redirect_url,
            "cancelUrl": cancel_url,
    ...
    # Try a range of endpoints: payment-links and checkout session variants
    endpoints = [
