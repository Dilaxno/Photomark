...
def get_pipe():
    ...
    # Allow redirecting the cache to a larger disk.
    # Recognize common env vars: HF_CACHE_DIR, HUGGINGFACE_HUB_CACHE, HF_HOME
    cache_dir = os.getenv("HF_CACHE_DIR") or os.getenv("HUGGINGFACE_HUB_CACHE") or os.getenv("HF_HOME")
    cache_kwargs = {}
    if cache_dir:
        try:
            ...
            # Ignore directory creation issues; fall back to default cache
            pass
