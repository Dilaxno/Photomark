...
# Vault helpers are imported inside the handler to avoid circular imports at module load time
...
async def upload(
    ...
    final_vault = None
    try:
        # Import vault helpers lazily to avoid circular imports at module load time
        from app.routers.vaults import (
            _read_vault, _write_vault, _vault_key,
            _read_vault_meta, _write_vault_meta, _vault_salt, _hash_password,
        )
